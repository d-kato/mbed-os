...
#ifndef __MEM_RZ_A2M_H
#define __MEM_RZ_A2M_H
...
/*--------------------- RAM Configuration -----------------------------------
 *----------------------------------------------------------------------------*/
#define __RAM_BASE       0x80004000
#define __RAM_SIZE       0x002E4000
#define __NC_RAM_SIZE    0x00100000
#define __NM_RAM_SIZE    (__RAM_SIZE - __NC_RAM_SIZE)
#define __DATA_NC_BASE   (__RAM_BASE + __NM_RAM_SIZE)
...
// </h>
 *----------------------------------------------------------------------------*/
#define __TTB_BASE       0x80000000
#define __TTB_SIZE       0x00004000

#endif /* __MEM_RZ_A2M_H */
