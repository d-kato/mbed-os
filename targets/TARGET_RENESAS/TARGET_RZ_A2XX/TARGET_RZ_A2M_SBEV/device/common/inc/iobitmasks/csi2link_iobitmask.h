...
#define CSI2LINK_FLD_FLD_EN1                                                   (0x00000001u)
#define CSI2LINK_FLD_FLD_EN1_SHIFT                                             (0u)
...
#define CSI2LINK_SERRCNT_ERRSOTHS_CUNT                                         (0x000000FFu)
#define CSI2LINK_SERRCNT_ERRSOTHS_CUNT_SHIFT                                   (0u)
#define CSI2LINK_SSERRCNT_ERRSOTSYNCHS                                         (0x0000000Fu)
#define CSI2LINK_SSERRCNT_ERRSOTSYNCHS_SHIFT                                   (0u)
#define CSI2LINK_ECCCM_ECC_CRCT_CUNT                                           (0x000000FFu)
#define CSI2LINK_ECCCM_ECC_CRCT_CUNT_SHIFT                                     (0u)
#define CSI2LINK_ECECM_ECC_ERR_CUNT                                            (0x000000FFu)
#define CSI2LINK_ECECM_ECC_ERR_CUNT_SHIFT                                      (0u)
#define CSI2LINK_CRCECM_CRC_ERR_CUNT                                           (0x000000FFu)
#define CSI2LINK_CRCECM_CRC_ERR_CUNT_SHIFT                                     (0u)
#define CSI2LINK_LCNT_LINE_CNT1                                                (0x0000FFFFu)
#define CSI2LINK_LCNT_LINE_CNT1_SHIFT                                          (0u)
#define CSI2LINK_LCNTM_MONI_LINECNT1                                           (0x0000FFFFu)
#define CSI2LINK_LCNTM_MONI_LINECNT1_SHIFT                                     (0u)
