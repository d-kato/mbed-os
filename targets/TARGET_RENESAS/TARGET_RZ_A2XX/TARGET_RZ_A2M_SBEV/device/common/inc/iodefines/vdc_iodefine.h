...
struct st_vdc
{
    ...
    union
    {
        ...
        struct
        {
            ...
            unsigned long :1;
            unsigned long INP_VSP_SYNC_SEL:1;
            unsigned long :3;
    ...
    union
    {
        ...
        struct
        {
            unsigned long INP_FH25:10;
            unsigned long :6;
            unsigned long INP_FH50:10;
            unsigned long :6;
        } BIT;
    } INP_VSYNC_PH_ADJ;
    union
    ...
    union
    {
        ...
        struct
        {
            unsigned long SC0_SC0_RES_VS_SEL:1;
            unsigned long :7;
            unsigned long SC0_RES_VS_IN_SEL:1;
            unsigned long :7;
            unsigned long SC0_OIR_RES_EN:1;
            unsigned long :15;
        } BIT;
    } SC0_SCL0_FRC3;
    union
    ...
    union
    {
        ...
        struct
        {
            unsigned short SC0_RES_LINSTAT:11;
            unsigned short :5;
        } BIT;
    } SC0_SCL0_MON0;
    union
    ...
    union
    {
        ...
        struct
        {
            ...
            unsigned long SC0_RES_DS_H_INIPHASE:12;
    ...
    union
    {
        ...
        struct
        {
            ...
            unsigned long :3;
            unsigned long GR0_ARC_DISP_ON:1;
            unsigned long :3;
            unsigned long GR0_ARC_ON:1;
            unsigned long :9;
            unsigned long GR0_ACALC_MD:1;
            unsigned long GR0_ARC_MUL:1;
            unsigned long :4;
            unsigned long GR0_CUS_CON_ON:1;
            unsigned long :3;
        } BIT;
    } GR0_AB1;
    union
    ...
    union
    {
        ...
        struct
        {
            unsigned long ADJ_MTX_GG:11;
            unsigned long :5;
            unsigned long ADJ_MTX_YG:8;
            unsigned long :8;
        } BIT;
    } ADJ0_MTX_YG_ADJ0;
    union
    {
        ...
        struct
        {
            unsigned long ADJ_MTX_GR:11;
            unsigned long :5;
            unsigned long ADJ_MTX_GB:11;
            unsigned long :5;
        } BIT;
    } ADJ0_MTX_YG_ADJ1;
    union
    {
        ...
        struct
        {
            unsigned long ADJ_MTX_BG:11;
            unsigned long :5;
            unsigned long ADJ_MTX_B:8;
            unsigned long :8;
        } BIT;
    } ADJ0_MTX_CBB_ADJ0;
    union
    {
        ...
        struct
        {
            unsigned long ADJ_MTX_BR:11;
            unsigned long :5;
            unsigned long ADJ_MTX_BB:11;
            unsigned long :5;
        } BIT;
    } ADJ0_MTX_CBB_ADJ1;
    union
    {
        ...
        struct
        {
            unsigned long ADJ_MTX_RG:11;
            unsigned long :5;
            unsigned long ADJ_MTX_R:8;
            unsigned long :8;
        } BIT;
    } ADJ0_MTX_CRR_ADJ0;
    union
    {
        ...
        struct
        {
            unsigned long ADJ_MTX_RR:11;
            unsigned long :5;
            unsigned long ADJ_MTX_RB:11;
            unsigned long :5;
        } BIT;
    } ADJ0_MTX_CRR_ADJ1;
    char           wk16[48];
    ...
    union
    {
        ...
        struct
        {
            ...
            unsigned long :2;
            unsigned long OUT_SUM_MOVE:5;
            unsigned long :2;
            unsigned long OUT_PIXEL_INV_ON:1;
    ...
    union
    {
        ...
        struct
        {
            ...
            unsigned long :3;
            unsigned long INT_STA10:1;
            unsigned long :3;
            unsigned long INT_STA11:1;
            unsigned long :3;
            unsigned long INT_STA12:1;
            unsigned long :3;
            unsigned long INT_STA13:1;
            unsigned long :3;
            unsigned long INT_STA14:1;
            unsigned long :3;
            unsigned long INT_STA15:1;
            unsigned long :3;
        } BIT;
    } SYSCNT_INT2;
    union
    {
        ...
        struct
        {
            unsigned long INT_STA16:1;
            unsigned long :3;
            unsigned long INT_STA17:1;
            unsigned long :3;
            unsigned long INT_STA18:1;
            unsigned long :3;
            unsigned long INT_STA19:1;
            unsigned long :3;
            unsigned long INT_STA20:1;
            unsigned long :3;
            unsigned long INT_STA21:1;
            unsigned long :3;
            unsigned long INT_STA22:1;
            unsigned long :3;
            unsigned long INT_STA23:1;
            unsigned long :3;
        } BIT;
    } SYSCNT_INT3;
    union
    ...
    union
    {
        ...
        struct
        {
            ...
            unsigned long :3;
            unsigned long INT_OUT10_ON:1;
            unsigned long :3;
            unsigned long INT_OUT11_ON:1;
            unsigned long :3;
            unsigned long INT_OUT12_ON:1;
            unsigned long :3;
            unsigned long INT_OUT13_ON:1;
            unsigned long :3;
            unsigned long INT_OUT14_ON:1;
            unsigned long :3;
            unsigned long INT_OUT15_ON:1;
            unsigned long :3;
        } BIT;
    } SYSCNT_INT5;
    union
    {
        ...
        struct
        {
            unsigned long INT_OUT16_ON:1;
            unsigned long :3;
            unsigned long INT_OUT17_ON:1;
            unsigned long :3;
            unsigned long INT_OUT18_ON:1;
            unsigned long :3;
            unsigned long INT_OUT19_ON:1;
            unsigned long :3;
            unsigned long INT_OUT20_ON:1;
            unsigned long :3;
            unsigned long INT_OUT21_ON:1;
            unsigned long :3;
            unsigned long INT_OUT22_ON:1;
            unsigned long :3;
            unsigned long INT_OUT23_ON:1;
            unsigned long :3;
        } BIT;
    } SYSCNT_INT6;
    union
    ...
    union
    {
        ...
        struct
        {
            ...
            unsigned short :3;
            unsigned short GR1_CLT_SEL_ST:1;
            unsigned short :3;
            unsigned short GR2_CLT_SEL_ST:1;
            unsigned short :3;
            unsigned short GR3_CLT_SEL_ST:1;
            unsigned short :1;
            unsigned short GR_OIR_CLT_SEL_ST:1;
            unsigned short :1;
        } BIT;
    } SYSCNT_CLUT;
    char           wk27[356];
