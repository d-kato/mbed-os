...
*******************************************************************************/ 
#ifndef OSTM0_IOBITMASK_H
#define OSTM0_IOBITMASK_H


/* ==== Mask values for IO registers ==== */

#define OSTM0_OSTMnCMP_OSTMnCMP                                                (0xFFFFFFFFu)
#define OSTM0_OSTMnCMP_OSTMnCMP_SHIFT                                          (0u)
#define OSTM0_OSTMnCNT_OSTMnCNT                                                (0xFFFFFFFFu)
...
#define OSTM0_OSTMnCTL_OSTMnMD0                                                (0x01u)
#define OSTM0_OSTMnCTL_OSTMnMD0_SHIFT                                          (0u)
#define OSTM0_OSTMnCTL_OSTMnMD1                                                (0x02u)
#define OSTM0_OSTMnCTL_OSTMnMD1_SHIFT                                          (1u)
