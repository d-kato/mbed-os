...
Macro definitions
******************************************************************************/
#define IOREG_MASK_8BIT         (0xFFFFFFFFuL)
#define IOREG_MASK_16BIT        (0xFFFFFFFFuL)
#define IOREG_MASK_32BIT        (0xFFFFFFFFuL)
#define IOREG_FULLMASK_VALUE    (0xFFFFFFFFuL)
#define IOREG_BIT_SHIFT_NONE    (0)
