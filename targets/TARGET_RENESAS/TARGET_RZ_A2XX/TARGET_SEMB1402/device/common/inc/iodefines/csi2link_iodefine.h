...
struct st_csi2link
{
    ...
    union
    {
        ...
        struct
        {
            unsigned long MONI_LINECNT1:16;
            unsigned long :16;
        } BIT;
    } LCNTM;
    char           wk13[4];
