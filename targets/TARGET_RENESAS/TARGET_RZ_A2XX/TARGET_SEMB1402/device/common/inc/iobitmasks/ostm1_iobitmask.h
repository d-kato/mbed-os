...
*******************************************************************************/ 
#ifndef OSTM1_IOBITMASK_H
#define OSTM1_IOBITMASK_H


/* ==== Mask values for IO registers ==== */

#define OSTM1_OSTMnCMP_OSTMnCMP                                                (0xFFFFFFFFu)
#define OSTM1_OSTMnCMP_OSTMnCMP_SHIFT                                          (0u)
#define OSTM1_OSTMnCNT_OSTMnCNT                                                (0xFFFFFFFFu)
...
#define OSTM1_OSTMnCTL_OSTMnMD0                                                (0x01u)
#define OSTM1_OSTMnCTL_OSTMnMD0_SHIFT                                          (0u)
#define OSTM1_OSTMnCTL_OSTMnMD1                                                (0x02u)
#define OSTM1_OSTMnCTL_OSTMnMD1_SHIFT                                          (1u)
